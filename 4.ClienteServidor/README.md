# Mastermind. Requisitos Cliente/Servidor
...
![Undo](./docs/diagrams/out/mastermind_usecases/undo_usecase.svg)  

## Vista de Caso de Uso Redo
![Redo](./docs/diagrams/out/mastermind_usecases/redo_usecase.svg)  
